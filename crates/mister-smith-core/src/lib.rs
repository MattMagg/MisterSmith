...
pub use autonomy::{
    ...
    DelegatedAction, DelegatedActionPolicy, DelegatedWorkEvidenceRef, DelegationCapability,
    ExecutionEvidenceClass, ExternalDelegationEnvelope, GroundedEvidenceReference, GuardDecision,
    ...
    SubagentStateRecord, SupervisionDecisionBasis, SupervisionEvidenceView, SupervisionTargetKind,
