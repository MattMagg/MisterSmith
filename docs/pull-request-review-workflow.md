...
- [ ] Check whether this is a draft or ready for review.
...
- [ ] Dependency vulnerabilities: Are new dependencies audited?
...
- [ ] Test quality: Are tests clear, maintainable, and not brittle?
...
# Use rg or other codebase search tools
...
- [ ] Database migrations: Are they reversible and tested?
...
If `FOCUS_AREAS` is specified, prioritize those sections and do a cursory review of others.
