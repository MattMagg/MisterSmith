...
# 4. Agent bridge and Gate 9 orchestration path
...
mock contract tests, real-provider integration tests, and Gate 9 orchestration validation.
...
6. The same flow succeeds with both Anthropic and OpenAI.
