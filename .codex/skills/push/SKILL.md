...
2. Confirm the working tree is clean enough to push.
3. Push to `origin`:
...
7. Write a concise PR title and body that cover:
   - problem
   - solution
   - validation commands run
8. Reply with the PR URL and attach it to the Linear issue.
